...
(function () {
  ...
  "ไม่ต้อง เปิดจากเว็บได้เลย ถ้าอยากใช้เหมือนแอป กด “แชร์ → เพิ่มลงในหน้าจอโฮม” บน iPhone หรือ “ติดตั้งแอป” บน Android แล้วจะได้ไอคอนเปิดเต็มจอ —": "No — open it in the browser. To use it like an app, tap \"Share → Add to Home Screen\" on iPhone or \"Install app\" on Android and you'll get a full-screen icon —",
  ...
  "สามอย่าง: ผู้ช่วย AI (แยกโปรแกรมทัวร์ ร่างแผนวัน เรียบเรียงเรื่องเล่า) · ไฟล์ที่โหลดออกไม่มีชื่อ Vela ทั้งเล่มและคลิป · เลือกรูปและเรียงลำดับคลิปเอง ยาวเท่าไหร่ก็ได้ — บวกกับสำรองรูปขึ้นคลาวด์และซิงก์ข้ามเครื่อง": "Three things: the AI assistant (splitting itineraries, drafting days, writing stories) · exports with no Vela mark, in books and clips · picking and ordering clip photos yourself, at any length — plus photo backup to the cloud and cross-device sync.",
...
Object.assign(window.VELA_WEB_EN, {
  ...
  "← ศูนย์ช่วยเหลือ": "← Help centre",
  "· เริ่มต้นใช้งาน": "· Getting started",
  "Vela เปิดจากเว็บได้เลย ไม่ต้องโหลดจาก App Store หรือ Play Store — แต่ถ้าติดตั้งลงหน้าจอโฮมสักครั้ง จะได้ไอคอนเหมือนแอปจริง เปิดเต็มจอ ไม่มีแถบเบราว์เซอร์มากวน และเปิดใช้ตอนไม่มีเน็ตได้ ใช้เวลาไม่ถึงหนึ่งนาที": "Vela runs straight from the web — no App Store or Play Store needed. Install it to your home screen once, though, and you get a real app icon, full screen with no browser bar, and it opens even with no connection. Takes under a minute.",
